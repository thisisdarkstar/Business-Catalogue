...
export default function EditProductPage() {
  ...
  const fetchProduct = async () => {
    ...
    if (data) {
      ...
      const loadedVariants = typeof data.variants === 'string' 
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="relative">
                ...
                <input
                  ...
                  list="color-suggestions-edit"
                  className="w-full px-4 py-3 rounded-xl bg-secondary border border-border focus:outline-none focus:ring-2 focus:ring-primary/50"
                />
                <datalist id="color-suggestions-edit">
                  {colorOptions.map((c) => (
            ...
            <div>
              ...
              <input
                ...
                multiple
                className="hidden"
                id="images-input-edit"
              />
              <div
                onClick={() => document.getElementById('images-input-edit')?.click()}
                className="border-2 border-dashed border-border rounded-xl p-8 text-center cursor-pointer hover:border-primary transition-colors"
              >
                {images.length > 0 ? (
                ...
                <div className="mt-4 p-4 bg-secondary/50 rounded-xl border border-border">
                  ...
                  <div className="flex gap-2">
                    ...
                    <input
                      ...
                      multiple
                      className="hidden"
                      id="variant-images-input-edit"
                    />
                    <button
                      type="button"
                      onClick={() => document.getElementById('variant-images-input-edit')?.click()}
                      className="px-4 py-2 rounded-xl bg-card border border-border hover:bg-accent transition-colors flex items-center gap-2"
                    >
                              ...
                              <div key={i} className="relative">
                                ...
                                <button
                                  ...
                                  onClick={() => {
                                    ...
                                    newVariants[idx] = { 
                                      ...newVariants[idx], 
                                      images: newVariants[idx].images?.filter((_: string, imgIdx: number) => imgIdx !== i) || null 
                                    };
                                    setVariants(newVariants);
                                  }}
                                  className="absolute -top-2 -right-2 p-2 sm:p-1.5 rounded-full bg-destructive text-destructive-foreground"
